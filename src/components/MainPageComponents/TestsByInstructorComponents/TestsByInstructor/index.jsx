...
function TestsByInstructor({ instructors, setInstructors, searchText, buttonValue }) {
  const { auth } = useAuth()
  ...
  if(searchText !== 'Todos'){
    filteredInstructor = instructors.filter(instructor => 
      instructor.instructorName === searchText
    )
  }
